    ...
    <footer className="bg-black text-white pt-4">
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-4">
          ...
          <div>
            <h3 className="font-semibold text-white">TradePro</h3>
            <ul className="space-y-2">
              {[
                "About Us",
                "Pricing",
        ...
        <div className="mt-8 border-gray-200 flex flex-col md:flex-row justify-between">
          <p className="text-sm text-gray-500 mb-4">
            {" "}&copy;2014-2025 TradePro. All rights reserved, Built with ❤️ in
            India
          </p>
        </div>
      </div>
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="overflow-x-hidden h-screen bar-style-1">
      <body>
        {children}
        <Footer />
      </body>
